    ...
    <div className={styles.container}>
      <div className={styles.layout}>
        ...
        <aside className={styles.leftColumn}>
          ...
          {status === 'loading' ? (
            <div className={styles.muted} style={{ textAlign: 'left', padding: 0 }}>
              Loading menu items…
            </div>
          ) : null}
        ...
        <main
          className={`
            ${styles.rightPanel}
            ${selected ? styles.mobilePopup : ''}
            ${selected ? globalPopupStyles.popupContent : ''}
            ${isClosing ? globalPopupStyles.closing : ''}
          `}
        >
          {/* mobile only close */}
          ...
          <div className={styles.reviewListContainer}>
            <div className={styles.reviewList}>
              ...
              {activeReviews.length === 0 ? (
                <div className={styles.muted}>No reviews yet. Be the first to share your experience!</div>
              ) : null}
            </div>
          </div>
